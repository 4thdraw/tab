$(document).ready(function(){
    ...
    $('.section1 .item_list').on('init', function (event, slick) {
        $(this).next(".slick-controls").append('<div class="slick-progress"><div class="progress"></div></div><div class="slick-counter"><span class="current">1</span> <i></i> <span class="total">'+slick.slideCount+'</span></div><div class="control"> <button class="control_pause active"><i class="ri-pause-line"></i><span class="sr-only">�뺤�</span></button><button class="control_play"><i class="ri-play-line"></i><span class="sr-only">�쒖옉</span></button></div>');
